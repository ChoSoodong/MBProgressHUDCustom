...
+ (void)showProgress:(CGFloat)progress toView:(UIView *)view; //view可以传nil 进度走完, 自动隐藏
+ (void)showProgress:(CGFloat)progress status:(NSString *)status toView:(UIView *)view; //进度走完, 自动隐藏
